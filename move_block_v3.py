...
# It ends just before: </div>\n</section> (the very last one before footer)
# Looking at the file, is at the end.
pattern_b10 = r'(  <h2 id="articulos">10\..*?)(</div>\s*</section>\s*<footer>)'
...
end_tag = match_b10.group(2)

# Remove block 10 from original position
text = text[:match_b10.start()] + end_tag
